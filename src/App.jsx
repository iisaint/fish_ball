                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex gap-2 text-xs text-white mt-2">
                                            <span className="bg-blue-400 px-3 py-1.5 rounded inline-block text-center" style={{lineHeight: '1.2'}}>不含硼砂</span>
                                            <span className="bg-blue-400 px-3 py-1.5 rounded inline-block text-center" style={{lineHeight: '1.2'}}>口感紮實</span>
                                            <span className="bg-blue-400 px-3 py-1.5 rounded inline-block text-center" style={{lineHeight: '1.2'}}>安心美味</span>
                                        </div>
                                    </div>
                                </div>
                                <div className="text-right">
                                    ...
                                    <table className="w-full text-sm">
                                        <thead className="bg-blue-100 text-blue-900 border-b border-blue-200">
                                            <tr>
                                                ...
                                                {PRODUCTS.map(p => (
                                                    <th key={p.id} className="px-2 py-2 text-center text-xs whitespace-nowrap">{p.name}</th>
                                                ))}
